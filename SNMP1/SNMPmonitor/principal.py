...
if __name__ == "__main__":
     ...
     OIDlist = ['1.3.6.1.2.1.25.3.3.1.2.196608'] # lista de oid a monitorear
     listDevices = []
     user = 'root'## usuario de mysql
     password = ''## la contraseña de msql
     database = 'devices'# nombre de la base de datos
     timeUPdate = 1 # tiempo de actualizaion en que pedira informacioin del cpu segundos
